...
class AddressBook {
    ...
    static ArrayList<AddressBookContact> list=new ArrayList<AddressBookContact>();
    static Scanner s=new Scanner(System.in);

    public void Add_Contact(AddressBookContact c) {
    ...
    public void editContact(AddressBookContact c, String f_name ) {
        for (int i = 0; i < list.size(); i++) {
            c = (AddressBookContact)list.get(i);
    ...
    public void deleteContact(AddressBookContact c,String f_name){
        for(int i = 0; i < list.size(); i++){
            c = (AddressBookContact)list.get(i);
            if(f_name.equals(c.getfirstName())){
                list.remove(i);
